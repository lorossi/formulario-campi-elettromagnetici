...
\centerline{Versione aggiornata al 06/07/2020}
\end{doublespacing}
\newpage
...
\begin{itemize}
	...
	\item Spessore pelle \( \delta = \dfrac{1}{\alpha} = \dfrac{1}{\displaystyle \sqrt{\pi f \mu \sigma}} \)
...
\begin{itemize}
	...
	\item Velocità di fase \( v_f = \dfrac{1}{\displaystyle\sqrt{L C}} \)
\end{itemize}
...
Per \textit{attenuazione specifica} si intende la \textit{somma} delle attenuazioni del \textit{dielettrico} ed del \textit{conduttore}.s
